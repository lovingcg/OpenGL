...
int main()
{
    ...
    Shader screenShader1("framebuffers_screen.vs", "framebuffers_screen1.fs");
    ...
    float quadVertices3[] = { // vertex attributes for a quad that fills the entire screen in Normalized Device Coordinates.
        // positions   // texCoords
        -1.f,  -0.5f,  0.0f, 1.0f,
        -1.f, -1.f,  0.0f, 0.0f,
        -0.5f,-1.f,  1.0f, 0.0f,
    ...
    float quadVertices4[] = { // vertex attributes for a quad that fills the entire screen in Normalized Device Coordinates.
        // positions   // texCoords
        0.5f,  -0.5f,  0.0f, 1.0f,
        0.5f, -1.f,  0.0f, 0.0f,
        1.f,-1.f,  1.0f, 0.0f,
    ...
    // load models
    // -----------
    Model backpack("resources/nanosuit/nanosuit.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < objectPositions.size(); i++)
        {
            ...
            backpack.Draw(shaderGeometryPass,false);
        }
        glBindFramebuffer(GL_FRAMEBUFFER, 0);
