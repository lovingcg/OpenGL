...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Plant Monster", NULL, NULL);
    if (window == NULL)
    {
    ...
    // load models
    // -----------
    Model ourModel("resources/Cerberus/Cerberus_LP.fbx");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        screenShader1.use();
        screenShader1.setInt("flag", flag);
        glBindVertexArray(quadVAO1);
        if (flag == 1) glBindTexture(GL_TEXTURE_2D, textureDepthbuffer);	// use the color attachment texture as the texture of the quad plane
        else glBindTexture(GL_TEXTURE_2D, textureColorbuffer);
        glDrawArrays(GL_TRIANGLES, 0, 6);
